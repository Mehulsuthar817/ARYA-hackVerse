...
function MissingPersons() {
  ...
  return (
    <section className="space-y-5">
      <header>
        <h1 className="font-display text-2xl font-bold text-steel-50">Missing Persons</h1>
        <p className="text-sm text-steel-300">Search and filter ongoing missing person records.</p>
      </header>

      <div className="grid gap-3 rounded-2xl border border-steel-700/80 bg-steel-900/80 p-4 shadow-card sm:grid-cols-3">
        <label className="relative sm:col-span-2">
          ...
          <input
            ...
            className="w-full rounded-xl border border-steel-600/85 py-2 pl-9 pr-3"
          />
        </label>
        ...
        <select
          ...
          className="w-full rounded-xl border border-steel-600/85 px-3 py-2"
        >
          <option>All</option>
      ...
      {loading ? (
        ...
        <p className="rounded-xl bg-steel-800/75 p-4 text-sm text-steel-200">No matching records found.</p>
      ) : (
