...
function Home() {
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col justify-center px-4 py-10 sm:px-6 lg:px-8">
      <section className="overflow-hidden rounded-3xl border border-navy-200 bg-white shadow-card">
        <div className="grid gap-8 p-8 md:grid-cols-2 md:p-12">
          <div className="space-y-6">
            <p className="inline-flex rounded-full bg-navy-100 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-navy-700">
            ...
            <p className="max-w-xl text-steel-700">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                to="/signup"
                className="inline-flex items-center gap-2 rounded-xl border border-navy-200 bg-white px-5 py-3 font-medium text-navy-800 hover:bg-navy-50"
              >
          ...
          <div className="grid gap-4 rounded-2xl bg-gradient-to-br from-navy-900 to-navy-700 p-5 text-white">
